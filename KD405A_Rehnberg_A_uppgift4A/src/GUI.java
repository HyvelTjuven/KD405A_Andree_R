...
public class GUI extends JFrame {
	...
	public GUI() {
		...
		/** Generates an error message if the human name is less than 3 characters long */
		...
		/** Generates an error message if the dog name is a blank field */
		...
		/** Prints the information from getInfo method in the Human class */
